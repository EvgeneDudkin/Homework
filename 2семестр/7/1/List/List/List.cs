...
{ 
    ...
    public class MyList<T> : IEnumerable<T>
    {
        ...
        public class ListEnumerator : IEnumerator<T>
        {
            ...
            {
                curElement = new ElementOfList(default(T), null, list.head);
                curIndex = -1;
                curCollection = list;
            }

            /// <summary>
            /// Метод, который берет следующий элемент
            /// </summary>
            /// <returns></returns>
            ...
            {
                curIndex = -1;
                curElement = new ElementOfList(default(T), null, curCollection.head);
            }
        }

        /// <summary>
        /// Возвращает ListEnumerator для этого списка  
        /// </summary>
        /// <returns></returns>
